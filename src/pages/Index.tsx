    ...
    <>
        ...
        <div className="container relative pb-16 md:pb-28 pt-32">
          <div className="max-w-3xl reveal-up">
            ...
            <p className="text-primary-foreground/85 text-base md:text-lg max-w-xl leading-relaxed mb-8">
              Rañola Surveying Services helps Masbate landowners settle
              boundaries, divide parcels, and secure documentation — with the
              precision modern transactions demand.
            </p>
      ...
      <section className="container py-20 md:py-28 grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
        <div className="relative aspect-[4/5] rounded-sm overflow-hidden shadow-deep">
          <img
            src={surveyor}
            alt="Total station theodolite in a green field"
            loading="lazy"
            className="absolute inset-0 h-full w-full object-cover"
          />
        ...
        <div>
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            Based in Poblacion 1, Mobo, we work directly with families and
            businesses across Masbate on relocation, subdivision, consolidation,
            and as-built surveys. We handle field work, plan preparation, and
            the back-and-forth with DENR, LRA, CENRO, and barangay offices so
            you don't have to.
          </p>
          <p className="text-muted-foreground leading-relaxed mb-8">
            Every plan that leaves our office is signed and sealed by a licensed
            Geodetic Engineer.
          </p>
          <Link
            to="/about"
      ...
      <section className="bg-secondary/30 border-y border-border">
        <div className="container py-20 md:py-28">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
            ...
            <Link
              to="/services"
              className="text-sm text-primary font-medium inline-flex items-center gap-2 hover:gap-3 transition-all"
            >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-px bg-border rounded-sm overflow-hidden shadow-soft">
            {SERVICES.map((s, i) => {
              ...
              const spanClass = cn(
                ...
                isLast &&
                  lgLeftover === 2 &&
                  "lg:col-span-1 sm:col-span-2 lg:col-start-2",
              );
              return (
                <Link
                  key={s.slug}
                  to={`/services/${s.slug}`}
                  className={cn(
                    "group bg-card p-7 md:p-9 hover:bg-secondary/40 transition-colors duration-300 ease-natural relative",
                    spanClass,
                  )}
                >
                  <Icon
                    className="h-6 w-6 text-primary/70 mb-6"
                    strokeWidth={1.4}
                  />
          ...
          {[
            {
              n: "01",
              t: "Consultation",
              d: "Send your documents and concerns over Facebook or phone. We assess scope and quote.",
            },
            {
              n: "02",
              t: "Document review",
              d: "We verify titles, tax declarations, and prior plans before stepping into the field.",
            },
            {
              n: "03",
              t: "Field work",
              d: "Our team measures, marks, and notifies adjoining owners as the survey requires.",
            },
            {
              n: "04",
              t: "Plan & filing",
              d: "Signed and sealed plan delivered, plus help with submission to concerned offices.",
            },
          ].map((p) => (
            <div key={p.n} className="border-t border-primary/30 pt-6">
              <div className="text-xs text-primary/60 tracking-widest mb-3">
                {p.n}
              </div>
      ...
      <section className="bg-secondary/30 border-y border-border">
        <div className="container py-20 md:py-28">
          <div className="text-center mb-12">
            <div className="text-xs uppercase tracking-[0.25em] text-muted-foreground mb-4">
              What clients say from FB Reviews
            </div>
          ...
          >
            ...
            <CarouselContent className="-ml-4">
              {[
                {
                  quote:
                    "Sobrang satisfied kami sa relocation survey nila. Akala namin mahirap hanapin ang exact boundary ng lupa namin, pero dahil sa kanilang precise instruments at malinaw na paliwanag, naging smooth lahat.",
                  name: "Gina Ayala",
                  role: "Client - Milagros",
                },
                {
                  quote:
                    "We hired them for a relocation survey and we were amazed by their accuracy. They explained every corner and boundary clearly, which gave us peace of mind.",
                  name: "Yesha Reyes",
                  role: "Client- Balud",
                },
                {
                  quote:
                    "Kung gusto mo ng peace of mind sa lupa, sila na ang piliin — tested and proven sa loob ng limang taon",
                  name: "Aikee Moran",
                  role: "Client - Baleno",
                },
                {
                  quote:
                    "Lubos kaming nasiyahan sa serbisyong ibinigay nila sa pag-relocate ng aming lupa. Tumpak at malinaw ang kanilang sukat at paliwanag.",
                  name: "Jenica Ann Macaraeg",
                  role: "Client - Cataingan",
                },
                {
                  quote:
                    "From relocation to subdivision, lahat ginawa nila nang maayos. Walang stress, walang confusion, at malinaw ang bawat gawa.",
